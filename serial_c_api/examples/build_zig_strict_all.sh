...
SHARED_SOURCES_WIN="../lw_serial_api.c ../lw_serial_api_grf250.c lw_platform_win_serial.c"
SHARED_SOURCES_LINUX="../lw_serial_api.c ../lw_serial_api_grf250.c lw_platform_linux_serial.c"
